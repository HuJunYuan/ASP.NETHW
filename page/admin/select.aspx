<%@ Page Title="" Language="C#" MasterPageFile="~/page/admin/MasterPage.master" AutoEventWireup="true" CodeFile="select.aspx.cs" Inherits="page_admin_select" %>
...
<div class="form-group col-lg-5 form-search">
    <asp:TextBox runat="server" ID="name" type="text" class=" input-medium   input-lg col-lg-6 "  placeholder="请输入查询的姓名"/>
  ...
  <div>
      ...
      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
          DataKeyNames="ID" DataSourceID="SqlDataSource1" Width="411px">
          <Columns>
      ...
      <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
          ...
          SelectCommand="SELECT * FROM [studentInfo] WHERE ([姓名] = @姓名)">
          <SelectParameters>
              <asp:ControlParameter ControlID="name" Name="姓名" PropertyName="Text" 
                  Type="String" />
          </SelectParameters>
      </asp:SqlDataSource>
